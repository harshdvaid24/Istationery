...
export const MAGENTO_CART_TOTAL = 'magento_cart_total';
...
export const MAGENTO_CART_LOADING = 'magento_cart_loading';
...
export const MAGENTO_AUTH_ERROR_RESET = 'magento_auth_error_reset';
...
export const SET_PRODUCT_REWARDS = 'SET_PRODUCT_REWARDS'
export const MAGENTO_REWARDS_LOADING = 'magento_rewards_loading';
export const RESET_PRODUCT_REWARDS = 'RESET_PRODUCT_REWARDS'

export const SET_FILTER_FOR_CATEGORY = 'SET_FILTER_FOR_CATEGORY'

export const RESET_FILTER_FOR_CATEGORY = 'RESET_FILTER_FOR_CATEGORY'
...
export const GET_CART_REWARD = 'GET_CART_REWARD' 
